Some of the code I wrote in Google Colab, and the NER code was written in Jupyter Notebook. Here, I am providing the link to the Google Colab files and the .ipynb file for NER only.
